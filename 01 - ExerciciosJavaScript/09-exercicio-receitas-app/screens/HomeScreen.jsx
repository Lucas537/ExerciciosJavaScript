...
const receitas = [
  ...
  },
  {
    ...
    ingredientes: [
      ...
      "2 colheres de ketchup", "2 colheres de mostarda", "Champignon a gosto", "Batata palha para acompanhar"
    ],
    modoPreparo: [
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Receita', { receita: item })}>
          <Card style={{ margin: 10 }}>
            ...
            <Card.Content>
              ...
              <Paragraph>Preparo: {item.tempoPreparo} | Porções: {item.porcoes}</Paragraph>
            </Card.Content>
          </Card>
        </TouchableOpacity>
      )}
